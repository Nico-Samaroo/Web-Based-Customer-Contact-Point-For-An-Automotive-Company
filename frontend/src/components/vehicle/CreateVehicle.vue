<template>
    <div class="edit-form">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="make" required v-model="vehicle.make"
                name="make" />
        </div>

        <div class="mb-3">
            <label for="model">Model</label>
            <input type="text" class="form-control" id="model" required v-model="vehicle.model"
                name="model" />
        </div>

        <div class="mb-3">
            <label for="year">Year</label>
            <input type="text" class="form-control" id="year" required v-model="vehicle.year"
                name="year" />
        </div>
